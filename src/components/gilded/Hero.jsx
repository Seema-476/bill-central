        ...
        <div className='bg-gilded-hero bg-no-repeat bg-cover bg-center'>
            ...
            <div className='flex flex-col justify-center items-center lg:justify-end lg:min-h-[730px]'>
                <div className='max-w-[1360px] px-4 mx-auto lg:mb-[129px] max-lg:py-24'>
                    ...
                    <p className='text-center font-Josefin text-white leading-[22.95px] text-lg max-md:text-base max-md:leading-[18px]'>
                        Remaining Presale Time
                    </p>
                    <div className='flex items-center justify-center gap-6 pt-[22px]'>
                        <button className='px-[34px] font-Josefin py-3.5 max-md:px-8 max-md:py-3 max-md:text-xl common-button rounded-[79px] text-white flex text-2xl leading-6 gap-2.5 hover:scale-105 transition-all duration-500 shadow-custom-3xl cursor-pointer'>
                            <Presale />
                            Presale
                        </button>
                        <button className='px-[34px] py-[13.4px] font-Josefin max-md:px-8 max-md:py-3 max-md:text-xl rounded-[79px] border border-white text-2xl leading-6 text-white hover:scale-105 transition-all duration-500 cursor-pointer'>
                            Join Now
                        </button>
                    </div>
                </div>
