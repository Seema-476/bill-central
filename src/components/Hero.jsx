        ...
        <div className='flex max-lg:flex-col justify-between xl:pt-[109px] md:py-12 py-9 max-lg:gap-9 relative'>
          ...
          <div className='lg:w-[50%] pr-4'>
            ...
            <Description text="Find and switch to the best energy, gas, and internet plans with ease. Our platform simplifies your search, letting you compare providers and make informed decisions, all in one place."
              classStyle="max-w-[506px] pt-4 lg:pb-[42px] pb-8" />

            <form method="get" id="emailForm" className='flex items-center justify-between md:p-[9px_9px_9px_22px] p-[7px_7px_7px_18px] bg-white rounded-tr-[100px] rounded-br-[100px] rounded-bl-[70px] w-full max-w-[476px] max-lg:mx-auto border border-off-white'>
          ...
          <div className='flex justify-center relative z-10'>
            <img src="/assets/images/webp/hero-image.webp" alt="hero" className='max-w-[558px] w-full' />
          </div>
        </div>
      </div>
    </div>
