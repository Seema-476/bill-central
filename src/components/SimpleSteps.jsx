        ...
        <div className='flex w-full'>
          {SWITCH_LIST.map((obj, item) => (
            <div className='relative group w-full ma x-w-[360px]'>
              ...
              <div className='absolute w-full h-full bg-light-blue opacity-70 z-10 top-0 left-0 group-hover:w-0 transition-all duration-600'>
              </div>
              <p className='absolute !whitespace-nowrap 2xl:bottom-64 xl:bottom-48 bottom-40 font-normal xl:text-custom-xl text-xl xl:leading-custom-6xl text-dark-blue z-20 -rotate-90 w-full group-hover:opacity-0 transition-all duration-600'>{obj.cardText}</p>
            </div>
          ))}
        </div>
      </div>
