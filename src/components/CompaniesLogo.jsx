    ...
    <div className='lg:pb-20 lg:pt-[54px] md:py-14 py-10'>
      <div className='lg:container max-lg:px-4'>
        <div className='max-lg:container'>
          <p className='font-normal md:text-custom-2xl sm:text-3xl text-2xl sm:leading-10 md:leading-custom-7xl text-deep-blue max-w-[548px] relative z-10 max-lg:text-center max-lg:mx-auto'>More Than <span className='font-bold text-sky-blue'>80,000</span>+ Companies Trust Bill Central </p>
       </div>
