      ...
      <div className='lg:max-w-[1324px] mx-auto container'>
        ...
        <div className='!m ax-w-[1140px] mx-auto relative container'>
          <div className='xl:block hidden'>
            <button className='!w-10 !h-10 border border-dark-blue rounded-[50%] flex justify-center items-center swiper-button-prev absolute -left-[65px]'><img src="/assets/images/svg/prev-arrow.svg" alt="prev" /></button>
          ...
          <Swiper
            ...
            {SLIDES.map((slide, index) => (
              <SwiperSlide key={index} className="border border-gray shadow-custom-xl p-5 max-w-[364px] rounded">
                <div className="flex gap-2">
                  <img src={slide.imageUrl} alt={slide.name} className="w-[60px]" />
                  <div>
                    <p className="font-normal text-2xl leading-9 text-black">{slide.name}</p>
                    <p className="font-normal text-base text-black opacity-50">{slide.username}</p>
                  </div>
                </div>
                <img src="/assets/images/svg/star.svg" alt="star" className="pb-[18px] pt-6" />
